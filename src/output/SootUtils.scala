...
object SootUtils {
  def init(): Unit = {
    ...
    Options.v.set_soot_classpath(List("C:\\projects\\java-aot\\java_runtime\\out\\production\\java_runtime", ".", "C:\\projects\\java-aot\\target\\classes").mkString(File.pathSeparator))
